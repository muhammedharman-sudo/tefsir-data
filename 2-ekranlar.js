...
async function _kelimeMealiYukleVeCiz(sNo, aNo, kmDiv) {
  ...
  try {
    ...
    kmDiv.innerHTML = '<div class="km-yukleniyor-mini">⚠️ Yüklenemedi. <button class="km-tekrar-btn" style="border:1px solid var(--border);background:none;border-radius:8px;padding:4px 10px;font-size:12px;color:var(--ink);cursor:pointer;">Tekrar dene</button></div>';
...
function ayetButonSatiri(sNo, aNo) {
  ...
  cevBtn.dataset.goster = 'derinlik'; // sadece derinlikte
